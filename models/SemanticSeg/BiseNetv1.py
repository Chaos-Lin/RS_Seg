...
# from ..subnet import Resnet18
from models.subnet.resnet import Resnet18
...
class BiSeNetV1(nn.Module):
    ...
    def __init__(self, args,  aux_mode='train'):
    # def __init__(self, args, n_classes=8, aux_mode='pred'):
